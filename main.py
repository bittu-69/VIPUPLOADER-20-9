...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", 7134052961))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "6624826381 7134052961").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7512168646:AAH7fd7TKzJ8Ih-sggsPYdFv9qgQ1WmB4zw",    
   api_id= 13794728,    
